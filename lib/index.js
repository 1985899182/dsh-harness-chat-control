 ...
 * addressed sidechat child: model selection and the current permission
 * preset.  Both routes validate the child before changing its next request;
 * neither route reads credentials or rewrites the parent session.
 */
