...
if (manifest.version !== '0.2.16') throw new Error(`Unexpected plugin version: ${manifest.version}`)
...
if (!installer.includes("[string]$Ref = 'v0.2.16'")) {
...
for (const phrase of ['1 条注释', 'dsh-better-sidebar@0.17.1', '原生 sidechat']) {
